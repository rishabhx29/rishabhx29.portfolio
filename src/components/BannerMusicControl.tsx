...
const flyingTrack = "/sounds/flying.mp3";
  ...
  return (
    <>
      ...
      <button
        ...
        aria-label={`${actionLabel} Flying by Tom Odell`}
        title={`${actionLabel} Flying by Tom Odell`}
        className="group relative flex h-9 items-center gap-2.5 rounded-full border border-black/10 bg-white/90 px-3 text-left text-zinc-950 shadow-sm shadow-black/10 backdrop-blur-md transition-all duration-300 ease-[cubic-bezier(0.23,1,0.32,1)] hover:-translate-y-[1px] hover:border-black/25 hover:bg-white hover:shadow-md active:scale-[0.96] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-zinc-950 disabled:cursor-not-allowed disabled:opacity-60 dark:border-white/10 dark:bg-[#171717]/90 dark:text-zinc-50 dark:shadow-black/60 dark:hover:border-white/25 dark:hover:bg-[#1e1e1e] dark:focus-visible:outline-zinc-50"
      >
        <span
